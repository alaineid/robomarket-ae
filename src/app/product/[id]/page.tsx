...
export default function ProductDetail() {
  ...
  const relatedProducts =
    relatedProductsData?.products?.filter((p) => p.id !== productId) || [];
    ...
    if (productData) {
      ...
      const saveToRecentlyViewed = () => {
        try {
          ...
          let viewedIds: number[] = recentlyViewed
      ...
      setBreadcrumbs([
        ...
        {
          label: productData.categories[0]?.name || "Uncategorized",
          path: `/shop?category=${encodeURIComponent(productData.categories[0]?.name || "")}`,
          isCurrent: false,
        },
        {
  ...
  const renderRatingStars = (rating: number) => {
    ...
    if (hasHalfStar) {
      stars.push(
        <FiStar
          key="half"
          className="text-yellow-400 fill-yellow-400 half-star"
        />,
      );
    }
        ...
        <div className="flex-grow flex items-center justify-center bg-gray-50">
          <div className="text-center max-w-md mx-auto p-6">
            ...
            <p className="text-gray-600 mb-8">
              {
                "We couldn't find the robot you're looking for. It may have been moved or doesn't exist."
              }
            </p>
            <Link
              href="/shop"
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <PageHero
          ...
          description={`${productData.brand} · ${productData.categories[0]?.name || "Uncategorized"}`}
          breadcrumbItems={breadcrumbs.map((item) => ({
            label: item.label,
            href: item.path,
        ...
        <Container>
              ...
              <div className="p-6 lg:p-10 order-1 lg:order-2 border-b lg:border-b-0 lg:border-l border-gray-100">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-sm">
                    <span className="text-[#4DA9FF] font-medium">
                    ...
                    <div className="flex items-center">
                      ...
                      <Link
                        ...
                        className="text-gray-600 hover:text-[#4DA9FF] transition-colors"
                      >
                        {productData.reviews.length} reviews
                      </Link>
                    </div>
                    <span className="text-green-600 font-medium flex items-center">
                      <FiCheck size={12} className="mr-1.5" /> In Stock
                    </span>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-4 text-sm">
                    <div className="flex items-center text-gray-600">
                      <FiTruck className="mr-1.5 text-[#4DA9FF]" />
                      Free Shipping
                    </div>
                    <div className="flex items-center text-gray-600">
                      <FiCreditCard className="mr-1.5 text-[#4DA9FF]" />
                      Financing Available
                    </div>
                    <div className="flex items-center text-gray-600">
                      <FiRefreshCw className="mr-1.5 text-[#4DA9FF]" />
                      30-Day Returns
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-gray-50 border border-gray-100 mb-8">
                  ...
                  {productData.description.length > 250 && (
                    ...
                    >
                      Read More <FiArrowRight className="ml-1 h-3 w-3" />
                    </button>
                  )}
                </div>
                ...
                <div className="mb-8">
                  <h3 className="text-lg font-bold text-gray-800 mb-4 flex items-center">
                    <FiAward className="mr-2 text-[#4DA9FF]" />
                    Key Features
                  </h3>
                ...
                <div className="mb-6 bg-blue-50 p-6 rounded-xl border border-blue-100">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                    ...
                    <div className="flex items-center bg-white px-3 py-1.5 rounded-lg">
                      ...
                      <span className="font-medium text-gray-900">
                        {productData.best_vendor.stock} units
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                    <div>
                      ...
                      <span className="text-gray-900 font-medium">
                        {productData.name.replace(/\s+/g, "-").toUpperCase()}
                      </span>
                    </div>
                    <div>
                      SKU:{" "}
                      <span className="text-gray-900 font-medium">
                        {productData.brand.substring(0, 2).toUpperCase()}-
                        {productData.id}00
                      ...
                      <div className="flex flex-wrap justify-between gap-6">
                        <div>
                          ...
                          <p className="text-gray-700 mt-1">
                            {productData.ratings.count} global ratings
                          </p>
                        </div>
          ...
          <section className="mb-16">
            <div className="flex justify-between items-center mb-8">
              ...
              >
                View All <FiArrowRight className="ml-2" size={12} />
              </Link>
            </div>
                  ...
                  >
                    ...
                    <div className="p-5 flex flex-col flex-grow">
                      <div className="mb-auto">
                        ...
                        <p className="text-xl font-bold text-[#4DA9FF]">
