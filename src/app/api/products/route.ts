...
export async function GET(request: Request) {
  ...
  const priceMax =
    Number(url.searchParams.get("price_max")) || Number.MAX_SAFE_INTEGER;
  ...
  switch (sortBy) {
    ...
    case "price-asc":
      query = query
        .order("best_vendor->price", { ascending: true })
        .order("id", { ascending: true });
      break;
    case "price-desc":
      query = query
        .order("best_vendor->price", { ascending: false })
        .order("id", { ascending: true });
      break;
    case "rating":
      query = query
    ...
    case "popularity":
      query = query
        .order("ratings->count", { ascending: false })
        .order("id", { ascending: true });
      break;
    default:
      query = query
