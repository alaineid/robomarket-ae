                      ...
                      <div className="mb-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div className="mt-1 pl-8 flex space-x-2">
                              ...
                              <div className="w-8 h-5 bg-white border border-gray-200 rounded flex items-center justify-center">
                                ...
                                >
                                  <path
                                    fill="#FF5F00"
                                    d="M22.5 12.4c0-5 4-9 9-9s9 4 9 9-4 9-9 9-9-4-9-9z"
                                  />
                                  <path
                                    fill="#EB001B"
                                    d="M22.5 12.4c0-5 4-9 9-9s9 4 9 9-4 9-9 9"
                                  />
                                  <path
                                    fill="#F79E1B"
                                    d="M25 3.5c-5 0-9 4-9 9s4 9 9 9a9 9 0 0 0 0-18z"
                                  />
                                </svg>
                              </div>
                            </div>
                          ...
                          <div
                            ...
                            onClick={() =>
                              handlePaymentMethodChange("apple-pay")
                            }
                          >
                            <div className="flex items-center mb-2">
                              <div
                                ...
                                <span className="flex items-center">
                                  ...
                                  <span className="ml-1 group relative">
                                    ...
                                    <span className="absolute bottom-full mb-2 w-36 rounded bg-gray-800 p-2 text-xs text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                                      The 3-4 digit code on the back of your
                                      card
                                    </span>
                                  </span>
                                </span>
                      ...
                      {paymentInfo.paymentMethod === "paypal" && (
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-700 mb-4">
                            ...
                            payment securely. After completing payment on
                            PayPal, you&apos;ll return here to review your
                            order.
                          </p>
                        ...
                        >
                          <div className="flex items-center mb-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                Simple, secure one-touch payment
                              </p>
                            </div>
                          </div>
                          <p className="text-sm text-gray-700 mb-4">
                            When you click &quot;Continue&quot;, you&apos;ll be
                            prompted to authorize payment with Apple Pay. Make
                            sure you&apos;re using a compatible device with
                            Apple Pay set up.
                          </p>
                          <div className="bg-gray-100 p-4 rounded-lg border border-gray-200 flex items-start">
                            ...
                            <p className="text-sm text-gray-600">
                              Apple Pay works on macOS devices with Touch ID or
                              when paired with an iPhone or Apple Watch that has
                              Apple Pay set up.
                            </p>
                          </div>
                        </motion.div>
                      ...
                      <div className="mb-8">
                        ...
                        <div className="border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                          {cartItems.map((item, index) => (
                            <div
                              key={index}
                              className="p-4 md:p-5 flex items-center border-b last:border-b-0 hover:bg-gray-50 transition-colors"
                            >
                              ...
                              <div className="ml-4 md:ml-6 flex-grow">
                                ...
                                {item.product?.best_vendor?.vendor && (
                                  <div className="text-xs text-gray-500 mt-1">
                                    Sold by:{" "}
                                    {typeof item.product.best_vendor.vendor ===
                                    "string"
                                      ? item.product.best_vendor.vendor
                                      : item.product.best_vendor.vendor?.name ||
                                        "Unknown vendor"}
                                  </div>
                                )}
                              </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="ml-3">
                            <p className="text-sm text-gray-700">
                              ...
                              <a
                                href="#"
                                className="text-[#4DA9FF] font-medium hover:underline"
                              >
                                Terms of Service
                              </a>{" "}
                              and{" "}
                              ...
                              order, support your experience, and for other
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="p-5">
                      ...
                      <div className="mb-4 flex items-center text-sm">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4 text-[#4DA9FF] mr-1.5"
                          viewBox="0 0 20 20"
                          fill="currentColor"
                        >
