            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-6">
                ...
                <div className="bg-blue-50 p-5 border-b border-blue-100 hidden sm:grid grid-cols-12 gap-4">
                  <div className="col-span-6 text-gray-700 font-semibold">
                    Product
                  </div>
                  <div className="col-span-2 text-gray-700 font-semibold text-center">
                    Price
                  </div>
                  <div className="col-span-2 text-gray-700 font-semibold text-center">
                    Quantity
                  </div>
                  <div className="col-span-2 text-gray-700 font-semibold text-right">
                    Total
                  </div>
                </div>
                  ...
                  {cartItems.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {item.product ? (
                            <Link
                              ...
                              className="font-medium text-gray-800 hover:text-[#4DA9FF] transition-colors line-clamp-2 text-lg"
                            >
                              {item.product.name}
                            </Link>
                          ) : (
                      ...
                      <div className="col-span-2 flex items-center justify-center">
                        ...
                        <div className="flex items-center border border-gray-300 rounded-lg bg-white shadow-sm">
                          ...
                          <button
                            ...
                            disabled={
                              item.quantity >=
                              (item.product?.best_vendor?.stock || 10)
                            }
                          >
                            <span className="text-xl font-medium">+</span>
                          </button>
                      ...
                      <div className="col-span-2">
                        <span className="sm:hidden font-semibold mr-2 text-gray-700">
                          Total:
                        </span>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        ${isNaN(subtotal) ? "0.00" : subtotal.toLocaleString()}
                      </span>
                    </div>
                  ...
                  <div className="mt-6">
                    <Link href="/checkout">
                      <motion.button
                        whileHover={{
                          scale: 1.01,
                          boxShadow: "0 8px 20px -5px rgba(77, 169, 255, 0.35)",
                        }}
                        whileTap={{ scale: 0.98 }}
                  ...
                  <div className="mt-5 text-sm text-center text-gray-500 flex items-center justify-center bg-gray-50 p-3 rounded-lg border border-gray-100">
                    <svg
                      ...
                      className="h-4 w-4 mr-1.5 text-[#4DA9FF]"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                    >
                      <path
                    ...
                    <div className="flex justify-center space-x-3">
                      <div className="w-10 h-7 bg-white border border-gray-200 rounded-md shadow-sm flex items-center justify-center">
                        ...
                        >
                          ...
                          <path
                            fill="#FFF"
                            d="M15 19h2v-2h-2v2zm-4 0h2v-2h-2v2zm-4 0h2v-2H7v2z"
                          />
                          <path
                            className="svg-stroke"
                            stroke="#FFF"
                            strokeWidth="2"
                            d="M18.5 7v9M16.8 11.2l3.5-4.4M16.8 11.8l3.5 4.4"
                          />
                        </svg>
                      </div>
                      <div className="w-10 h-7 bg-white border border-gray-200 rounded-md shadow-sm flex items-center justify-center">
                        ...
                        >
                          <path
                            opacity=".07"
                            d="M35 0H5C2.3 0 0 2.3 0 5v14c0 2.7 2.4 5 5 5h30c2.8 0 5-2.2 5-5V5c0-2.7-2.3-5-5-5z"
                          />
                          <path
                            fill="#fff"
                            d="M35 1c2.3 0 4 1.8 4 4v14c0 2.2-1.8 4-4 4H5c-2.2 0-4-1.8-4-4V5c0-2.2 1.7-4 4-4h30"
                          />
                          <path
                            fill="#EB001B"
                            d="M15 12c0-2.4-1.2-4.5-3-5.7-1.8 1.3-3 3.4-3 5.7s1.2 4.5 3 5.7c1.8-1.2 3-3.3 3-5.7z"
                          />
                          <path
                            fill="#F79E1B"
                            d="M31 12c0-2.4-1.2-4.5-3-5.7-1.8 1.3-3 3.4-3 5.7s1.2 4.5 3 5.7c1.8-1.2 3-3.3 3-5.7z"
                          />
                          <path
                            fill="#FF5F00"
                            d="M22 12c0-2.4 1.2-4.5 3-5.7-1.8-1.2-4-2-6.2-2-6.2 0-11.2 5-11.2 11.2 0 6.2 5 11.2 11.2 11.2 2.2 0 4.2-.7 6-2-1.8-1.2-3-3.3-3-5.7z"
                          />
                        </svg>
                      </div>
                      <div className="w-10 h-7 bg-white border border-gray-200 rounded-md shadow-sm flex items-center justify-center">
