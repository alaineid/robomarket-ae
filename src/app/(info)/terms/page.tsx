          ...
          <div className="container mx-auto px-4 max-w-[2400px]">
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm p-8">
              <div className="prose max-w-none">
                <p className="lead">
                  Welcome to ROBOMARKET. These Terms and Conditions
                  (&quot;Terms&quot;) govern your access to and use of the
                  ROBOMARKET website, platform, and services (collectively, the
                ...
                <p>
                  ...
                  (&quot;Manufacturers&quot;) of robotics and related products
                  (&quot;Products&quot;). ROBOMARKET does not design,
                  manufacture, store, inspect, or endorse any Products listed on
                  the Platform. We facilitate transactions between buyers and
                  Manufacturers.
                </p>
                <p>
                  To the fullest extent permitted by applicable law, ROBOMARKET
                  shall not be liable for any direct, indirect, incidental,
                  special, consequential, or punitive damages, including but not
                  limited to, damages for loss of profits, goodwill, use, data,
                  or other intangible losses, arising out of or relating to your
                  access to or use of, or inability to access or use, the
                  Platform or any Products purchased through the Platform. This
                  includes, but is not limited to, any damages resulting from
                  Product use, misuse, defects, or failure.
                </p>
                <p>
                  {
                ...
                <p>
                  ...
                  ROBOMARKET immediately of any unauthorized use of your account
                ...
                <p>
                  All orders placed through the Platform are subject to
                  acceptance by the Manufacturer. ROBOMARKET facilitates the
                  payment process but does not handle or physically inspect any
                  Product prior to shipment unless explicitly stated otherwise.
                  Shipping and delivery are the responsibility of the
                  Manufacturer or their authorized logistics provider, as
                  outlined in our Shipping & Delivery Policy. Payment processing
                  services are provided by third-party gateways, and your use of
                  these services is subject to their terms and conditions.
                </p>
                ...
                <p>
                  ROBOMARKET reserves the right to suspend or terminate your
                  account and access to the Platform, without notice and at its
                  sole discretion, if it believes you have violated these Terms,
                  engaged in fraudulent or illegal activities, or taken actions
                  harmful to the Platform, its users, or third parties.
                </p>
                ...
                <p>
                  ROBOMARKET shall not be held liable for any failure or delay
                  in the performance of its obligations under these Terms (such
                  as platform availability) caused by circumstances beyond our
                  reasonable control, including but not limited to acts of God,
                  war, terrorism, government restrictions or actions, natural
                  disasters, pandemics, strikes, labor disputes, internet or
                  telecommunication outages, or failure of third-party service
                  providers.
                </p>
                ...
                <p>
                  ...
                  United Arab Emirates as applied in the Emirate of Dubai. Any
                  ...
                  competent courts of Dubai, United Arab Emirates, unless
                  otherwise agreed by ROBOMARKET in writing.
                </p>

                <h2 className="text-2xl font-bold mt-8 mb-4">9. Amendments</h2>
                <p>
                  ROBOMARKET reserves the right to modify these Terms at any
                  time. We will notify you of significant changes by posting the
                  new Terms on the Platform or by sending you an email
                  notification. Your continued use of the Platform after such
                ...
                <p>
                  ...
                  at:{" "}
                  <a
                    href="mailto:hello@robomarket.ae"
                ...
                <p className="lead">
                  ...
                  products purchased through the ROBOMARKET platform. Please
                  note that ROBOMARKET acts as a marketplace, and returns are
                  primarily governed by the policies of the individual
                  Manufacturer from whom you purchased the product.
                </p>
                ...
                <ul className="list-disc pl-6 mb-4">
                  <li>
                    <strong>Defective on Arrival (DOA):</strong> The product
                    does not function correctly right out of the box.
                  </li>
                  <li>
                    <strong>Damaged During Shipping:</strong> The product
                    packaging or the product itself shows clear signs of damage
                    sustained during transit. (See Shipping & Delivery Policy
                    for reporting requirements).
                  </li>
                  <li>
                    <strong>Significantly Not as Described:</strong> The product
                    received is fundamentally different from the item ordered or
                    described on the Platform (e.g., wrong model, missing core
                    advertised features, substantially incorrect
                    specifications). Minor variations in color or appearance may
                    not qualify.
                  </li>
                </ul>
                <p>
                  Return requests must typically be initiated within 14 calendar
                  days of the confirmed delivery date. Please check the specific{" "}
                  {"Manufacturer's"} return policy, often available on the
                  product page or their website, as their timeframe may apply.
                  Latent defects discovered after this initial period may be
                  covered under the {"Manufacturer's"} warranty, and claims
                  should be directed to the Manufacturer accordingly.
                </p>
                ...
                <p>
                  ...
                  eligibility, repair, replacement, or refund rest with the
                  original Manufacturer and are subject to their individual
                  warranty and return policies. ROBOMARKET requires
                  Manufacturers listing on the Platform to maintain reasonable
                  return and warranty policies, but we do not process returns or
                  issue refunds directly unless explicitly stated otherwise.
                </p>
                <p>
                  ROBOMARKET is not typically involved in the return
                  communication or dispute resolution process between the
                  customer and the Manufacturer. However, if you have initiated
                  a return request with the Manufacturer following the correct
                  procedure and have not received a substantive response
                  (acknowledgment or resolution steps) within 5 business days,
                  please contact ROBOMARKET support at{" "}
                  <a
                    href="mailto:support@robomarket.ae"
                    className="text-blue-500 hover:text-blue-700"
                  >
                    support@robomarket.ae
                  </a>{" "}
                  with your order details and evidence of your communication
                  attempt. In such cases, ROBOMARKET may, at its discretion,
                  attempt to facilitate communication between you and the
                  Manufacturer to encourage a response. This facilitation role
                  does not imply ROBOMARKET assumes liability for the return
                  outcome, which remains subject to the {"Manufacturer's"}{" "}
                ...
                <p className="lead">
                  This policy details how products ordered through ROBOMARKET
                ...
                <p>
                  ROBOMARKET currently facilitates orders for shipment to
                  addresses within the Gulf Cooperation Council (GCC) countries:
                  United Arab Emirates (UAE), Kingdom of Saudi Arabia (KSA),
                  Kuwait, Oman, Bahrain, and Qatar. We may expand to additional
