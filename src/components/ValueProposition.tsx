      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 transform transition duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <h3 className="font-bold text-2xl mb-4 text-center">Verified Quality</h3>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 transform transition duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <h3 className="font-bold text-2xl mb-4 text-center">Advanced Technology</h3>
            <p className="text-gray-600 text-center">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 transform transition duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <h3 className="font-bold text-2xl mb-4 text-center">Dedicated Support</h3>
            <p className="text-gray-600 text-center">
